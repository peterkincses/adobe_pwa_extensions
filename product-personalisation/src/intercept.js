...
module.exports = targets => {
    ...
    talons.tap(({ MiniCart }) => {
        MiniCart.useMiniCart.wrapWith('@bat/product-personalisation/src/targets/useMiniCartWrapper');
    });

    talons.tap(({ CartPage }) => {
        CartPage.ProductListing.useProductListing.wrapWith('@bat/product-personalisation/src/targets/useCartPageProductListingWrapper');
    });

    talons.tap(({ CartPage }) => {
        CartPage.ProductListing.useProduct.wrapWith('@bat/product-personalisation/src/targets/useCartPageProductListingProductWrapper');
    });
